<form action="{{ route('Usuarios.update', $usuario->id) }}" method="post" enctype="multipart/form-data">
    {{ method_field('patch') }}
    {{ csrf_field() }}
    <div class="modal fade" id="ModalEdit{{ $usuario->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2 p-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name"
                            ...
                            placeholder="Nombre/Apellido" required="" value="{{ $usuario->name }}">
                    </div>
                    <div class="col-span-2">
                        <label for="name"
                    ...
                    <div class="col-span-2">
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirmar la
                            Contraseña</label>
