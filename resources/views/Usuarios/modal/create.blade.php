        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Crear Nuevo Usuario</h1>
                    ...
                    <!-- Modal Body -->
    <form action="{{ route('Usuarios.store') }}" method="post" class="p-4 md:p-5">
            {{ csrf_field() }}
                <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
                    <label for="Select" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
